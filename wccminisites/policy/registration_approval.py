...
from wccminisites.policy.interfaces import IRegistrationApproval
from wccminisites.policy.events import (
...
registerToolInterface('wcc_minisites_registration_approval', IRegistrationApproval)